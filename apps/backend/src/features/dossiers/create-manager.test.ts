...
import { createDossierManager } from './create-manager.js';
import fs from 'fs';
...
describe('DossierManager', () => {
  ...
  it('creates a dossier with state.md and correct structure', () => {
    mgr.createDossier('invoices-acme', 'Generate invoices for Acme');
  ...
  it('creates dossier from suggestion, removes suggestion file', () => {
    ...
    mgr.createDossierFromSuggestion('tax-filing');
