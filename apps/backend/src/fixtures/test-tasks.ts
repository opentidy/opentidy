...
export const TEST_TASKS: TestTask[] = [
  ...
  // --- MONITORING EMAIL ---
  {
    ...
    instruction:
      'Surveille mes emails pendant les prochaines 2 heures. Si je reçois un email avec "URGENT" dans le sujet, résume-le et envoie-moi un récap à l.denblyden@gmail.com avec le sujet "Alfred — Email urgent détecté". Note chaque vérification dans state.md.',
    confirm: false,
