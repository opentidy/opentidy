...
describe('Notifier', () => {
  ...
  beforeEach(() => {
    ...
    notifier = createNotifier({
      sendMessage: mock.fn,
      appBaseUrl: 'https://alfred.loaddr.com',
    });
  });
  ...
  it('notifyStarted records notification without sending Telegram message', async () => {
    ...
    expect(store.record).toHaveBeenCalledWith({
      ...
      link: 'https://alfred.loaddr.com/dossiers/impots-2025',
  ...
  it('notifyMfa sends MFA required message with link', async () => {
    ...
    expect(mock.sent[0].text).toContain('https://alfred.loaddr.com/dossiers/banque-lcl');
  });
  ...
  it('notifyCompleted sends completion message with link', async () => {
    ...
    expect(mock.sent[0].text).toContain('https://alfred.loaddr.com/dossiers/impots-2025');
  });
  ...
  it('notifySuggestion sends notification for urgent suggestions', async () => {
    ...
    expect(mock.sent[0].text).toContain('https://alfred.loaddr.com/suggestions');
  });
  ...
  it('all dossier notifications contain a link to the dossier', async () => {
    ...
    expect(mock.sent[0].text).toContain('https://alfred.loaddr.com/dossiers/d1');
    expect(mock.sent[1].text).toContain('https://alfred.loaddr.com/dossiers/d2');
    expect(mock.sent[2].text).toContain('https://alfred.loaddr.com/dossiers/d3');
    expect(mock.sent[3].text).toContain('https://alfred.loaddr.com/dossiers/d4');
  });
