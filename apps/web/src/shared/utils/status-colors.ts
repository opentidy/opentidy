...
/** Job status → visual config (dot color, badge text/bg, i18n label key) */
export const jobStatusConfig: Record<string, { dot: string; badge: string; badgeBg: string; labelKey: string }> = {
