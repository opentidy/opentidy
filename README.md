...
| **Web dashboard** | ✅ Supported | Real-time SSE at `localhost:5175` |
...
Both backend and frontend follow **Vertical Slice Architecture**, with code organized by feature, not by layer. Each feature directory is self-contained: route, handler, logic, and tests in one place. [Read more →](docs/architecture.md)
