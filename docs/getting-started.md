...
This guide walks you through installing OpenTidy, running the setup wizard, and creating your first dossier.
...
OpenTidy sends you notifications via Telegram (dossier completed, checkpoint reached, errors).
...
1. Click **New Dossier** in the dashboard
...
- When done, the dossier status changes to **completed**

### Taking over

If you want to interact directly with Claude on a dossier:

1. Open the dossier in the dashboard
